...
//               <Image src={card.image} alt={card.title} className="mb-2 rounded w-full h-auto" width={500} height={300} />
...
const ProductCategories = () => {
  ...
  return (
    <div className="text-black p-8">
      ...
      {/* Section 1 */}
      <div className="mb-12">
        <h2 className="text-xl font-bold mb-6">Section 1</h2>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {cardsSection1.map((card, index) => (
            <div key={index} className="bg-gray-800 p-4 rounded-lg overflow-hidden">
      ...
      {/* Section 2 */}
      <div>
        <h2 className="text-xl font-bold mb-6">Section 2</h2>
